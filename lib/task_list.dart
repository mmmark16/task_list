              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                        height: 1, color: MediaQuery.of(context).platformBrightness == Brightness.light ?  Color.fromRGBO(235, 235, 235, 1) : Color.fromRGBO(41, 41, 47, 1)
                    ),
                  ),
                  Expanded(
                    child: ListView(
                        ...
                        children: List.generate(nameTitle.length, (index) {
                          if (checklist[index] == null) {
                            return TextField(
                              style: TextStyle(color: MediaQuery.of(context).platformBrightness == Brightness.light ?  Color.fromRGBO(87, 87, 103, 1) : Color.fromRGBO(218, 218, 218, 1)),
